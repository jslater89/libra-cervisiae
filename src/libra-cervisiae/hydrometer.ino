...
// determined by regression of the values generated by the function found here:
// https://alcohol.stackexchange.com/questions/1064/by-volume-by-weight-conversion-formula
// It's a good fit between about 0.5% and 9% ABV.
double calculateABV(double abw) {
  double intermediate = 0.116 + (abw * 0.914) + (abw*abw * -0.0605) + (abw*abw*abw * -0.00274) + (abw*abw*abw*abw * -0.0000481);
  if(intermediate > 0.5) return intermediate;
  else                   return abw * 3 / 4;
}
